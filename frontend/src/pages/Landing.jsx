    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-warm-50 to-orange-50">
      ...
      <header className="bg-white/80 backdrop-blur-sm border-b border-gray-100 sticky top-0 z-40">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-primary-500 rounded-xl flex items-center justify-center text-white font-bold">🏠</div>
            <span className="font-bold text-gray-800 text-lg">Little Stars Daycare</span>
          </div>
          <div className="flex items-center gap-2">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 pt-16 pb-12 text-center">
        ...
        <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 leading-tight mb-4">
          Welcome to<br />
          <span className="text-primary-500">Little Stars Daycare</span>
        </h1>
        <p className="text-lg text-gray-500 max-w-xl mx-auto mb-8">
          Enroll your child quickly and easily. Fill out the Texas state enrollment form online,
          save your progress, and submit when you're ready.
        </p>
      ...
      <section className="border-t border-gray-200 bg-white/60">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
            <h3 className="font-semibold text-gray-800 mb-1">Daycare Staff?</h3>
      ...
      <footer className="text-center py-6 text-xs text-gray-400">
        © {new Date().getFullYear()} Little Stars Daycare · Texas Form 2935
      </footer>
    </div>
  );
}
